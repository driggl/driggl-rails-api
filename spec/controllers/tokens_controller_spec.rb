...
RSpec.describe TokensController, type: :controller do
  ...
  describe 'POST :create' do
    context 'when invalid request' do
      ...
      it 'should contain valid json api error object' do
        post :create
    ...
    context 'when success request' do
      ...
      it 'should create user if does not exist' do
        expect{ subject }.to change{ User.count }.by(1)
      end

      it 'should create token if does not exist' do
  ...
  describe 'DELETE :destroy' do
    ...
    context 'when authorization is valid' do
      ...
      it 'should hae 204 status code' do
