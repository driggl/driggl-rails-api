...
describe ArticlesController do
  ...
  describe 'PUT :update' do
    context 'when user is not authorized' do
      ...
      it 'should return error information in the resopnse body' do
        put :update, params: { id: 1 }
        expect(json['errors'][0]).to eq(authorization_error)
      end
    end
    ...
    context 'when user is authorized' do
      ...
      context 'when invalid request' do
        ...
        it 'should return 422 http status if article is invalid' do
          put :update, params: invalid_article_attributes.merge(id: article.id)
          expect(response).to have_http_status(:unprocessable_entity)
        end
      ...
      context 'when trying to update not owned article' do
        ...
        it 'should not update not owned article' do
          put :update, params: valid_article_attributes.merge({ id: other_article.id })
  ...
  describe 'DELETE :destroy' do
    ...
    context 'when user is authorized' do
      ...
      context 'when trying to destroy not owned article' do
        ...
        it 'should not destroy not owned article' do
          expect{ delete :destroy, params: { id: other_article.id } }.not_to change{ Article.count }
